...
export const PlanBadge: React.FC<PlanBadgeProps> = ({
  ...
  return (
    <div
      className={`flex items-center gap-2 p-2 rounded-xl bg-zinc-800/50 border border-zinc-700/50 cursor-pointer hover:bg-zinc-700/50 transition-colors ${className}`}
      onClick={handleClick}
    >
      {/* Plan badge */}
      <div
